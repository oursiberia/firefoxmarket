...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    return {
        ...
        link: function($scope, $el, $attr) {
            ...
            rating = parseInt(stars[1]) >= 5 ? parseInt(stars) + 1 : parseInt(stars);
    ...
    id = id[id.length - 1], API.request("app_detail", id + "/").then(function(data) {
        ...
        $scope.support_url = data.support_url[navigator.language], $scope.tags = data.tags, 
        $scope.versions = data.versions, $rootScope.loaded();
    ...
    API.request("featured").then(function(data) {
        console.log(data);
        var apps = $filter("DesktopApps")(data.objects), index = Math.floor(Math.random() * apps.length), featured = apps[index];
        ...
        $scope.featured_apps = apps, $scope.loadAll = function() {
            ...
            var apps = $filter("DesktopApps")(data.objects);
            $scope.popularapps = apps, console.log(apps), $rootScope.loaded();
    ...
    return function(data, length) {
        ...
        obj.classname = "app", obj.device = "desktop", apps.push(obj));
        return apps;
    };
});