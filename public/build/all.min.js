...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    navigator.id.watch({
        ...
        var final_manifest = "";
        final_manifest = void 0 !== manifest ? manifest : $scope.manifest, req = "hosted" === app_type ? navigator.mozApps.install(final_manifest) : "packaged" === app_type ? navigator.mozApps.installPackage(final_manifest) : navigator.mozApps.install(final_manifest), 
        req.onsuccess = function() {
            console.log("Install process initiated"), notifyMe(appname + " was installed");
        }, req.onerror = function() {
            console.log("Install process failed"), notifyMe("The was a error with the installation process", this.error.name);
        };
    };
