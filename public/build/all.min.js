...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    var rules = {
        ...
        getImage: function(app) {
            var ratings = app.content_ratings, image = new Image();
            switch (console.log(ratings), ratings.body) {
              case "generic":
              ...
              case "esrb":
                for (var rule = rules.bodes[1], i = 0; i < rule.rating_types.length; ++i) rule.rating_types[i].ratingNumber === ratings.rating && (image.src = rule.rating_types[i].img);
            }
            return image;
        }
    };
    ...
    id = id[id.length - 1], $scope.appid = id, API.request("ratings", "?app=" + id + "&limit=999999").then(function(data) {
        ...
        console.log(image), $scope.name = data.name[navigator.language], $scope.icon = data.icons[128];
