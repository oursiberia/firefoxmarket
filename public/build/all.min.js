...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    var iso, current_category = "", is_showing_category = !1;
    API.request("featured").then(function(data) {
        ...
        for (var i = 0; 4 > i; ++i) apps[i].showfirst = "showfirst";
        $scope.featured_apps = apps, $scope.loadAll = function() {
            iso.arrange({
                filter: ".app"
            });
    ...
    return function(data, length) {
        ...
        obj.classname = "app", obj.rating = data[i].ratings.average, void 0 !== data.description && (obj.description = data.description[navigator.language]), 
