...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    var s = setInterval(function() {
        ...
        null !== username && ((null !== localStorage.getItem("username") || void 0 !== localStorage.getItem("username")) && (username.innerHTML = localStorage.getItem("username")), 
        clearInterval(s));
    }, 100);
    navigator.id.watch({
        loggedInUser: "",
        onlogin: function(assertation) {
            $.post("https://marketplace.firefox.com/api/v1/account/login/", {
                ...
                TweenMax.to(username, 1, {
                    opacity: 0,
                    onComplete: function() {
                        username.innerHTML = data.settings.display_name, localStorage.setItem("username", data.settings.display_name), 
                        localStorage.setItem("email", data.settings.email), localStorage.setItem("token", data.token), 
                        localStorage.setItem("installed_apps", data.apps.installed), localStorage.setItem("purchased_apps", data.apps.purchaed), 
    ...
    var query = "", $scope = null, API = {
        ...
        query: function(_$scope, limit) {
            ...
            void $http({
                ...
                $scope.category_results = category_results, $scope.description_results = description_results; else for (var i = 0; limit > i; ++i) console.log("results : ", author_results[i]);
            }).error(function(data) {
