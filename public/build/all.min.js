...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    id = id[id.length - 1], $scope.appid = id, API.request("ratings", "?app=" + id + "&limit=999999").then(function(data) {
        ...
        $scope.rating = data.ratings.average, console.log(data), $scope.rating_image = AgeRatingLookup.getImage(data), 
        $scope.name = data.name[navigator.language], $scope.version = data.current_version, 
    ...
    API.request("featured", "&cat=" + category).then(function(data) {
        ...
        for (var a = 0; a < sections.length; ++a) for (var section = sections[a], c = 0; c < section.apps.length; ++c) {
    ...
    return function(data, length) {
        ...
        for (var i = 0; limit > i; ++i) for (var obj = {}, a = 0; a < data[i].device_types.length; ++a) {
            ...
            obj.name = data[i].name["en-US"], obj.id = data[i].id, obj.manifest_url = data[i].manifest_url, 
