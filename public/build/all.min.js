...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    id = id[id.length - 1], $scope.appid = id, API.request("ratings", "?app=" + id + "&limit=999999").then(function(data) {
        ...
        $scope.rating_image = AgeRatingLookup.getImage(data), console.log(data), $scope.name = data.name[navigator.language], 
    ...
    $scope.changeTabContent(tabs, !0), $scope.initPurchase = function(app_type, manifest) {
        ...
        var final_manifest = "";
        final_manifest = void 0 !== manifest ? manifest : $scope.manifest;
        var req = null;
        "hosted" === app_type ? req = navigator.mozApps.install(final_manifest) : "packaged" === app_type && (req = navigator.mozApps.installPackage(final_manifest)), 
        ...
        box.className = box.className.replace("closed", ""), box.addEventListener("click", function() {
            TweenMax.to(box, .5, {
                opacity: 0,
                onComplete: function() {
                    document.getElementsByTagName("html")[0].style.overflow = "scroll", box.className = "modal closed";
