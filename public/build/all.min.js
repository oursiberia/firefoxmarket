...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    var query = "", $scope = null, API = {
        ...
        query: function(_$scope, term) {
            ...
            console.log("QUERY IS", query), $http({
                method: "GET",
    ...
    return {
        ...
        controller: function($scope) {
            $scope.$on("CATEGORY_RECENT", function() {
                for (var popular = document.getElementsByClassName("popular-category"), recent = document.getElementsByClassName("recent-category"), i = 0; i < popular.length; ++i) popular[i].style.display = "none";
                for (var i = 0; i < recent.length; ++i) recent[i].style.display = "block";
            }), $scope.$on("CATEGORY_POPULAR", function() {
                for (var popular = document.getElementsByClassName("popular-category"), recent = document.getElementsByClassName("recent-category"), i = 0; i < popular.length; ++i) popular[i].style.display = "block";
                for (var i = 0; i < recent.length; ++i) recent[i].style.display = "none";
