...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    return {
        ...
        link: function($scope, $el, $attr) {
            ...
            if ("true" === $attr.review) var s = setInterval(function() {
                "" !== $attr.rating ? (rating = parseInt($attr.rating), console.log("rating is ", rating), 
                applyStars(), clearInterval(s)) : console.log("rating missing!");
            }); else {
    ...
    API.request("featured", "&cat=" + category).then(function(data) {
        ...
        $scope.featuredapps = fapps, $scope.$emit("team_list_built"), swapApp();
