...
app.config(function($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
    ...
    var query = "", $scope = null, API = {
        ...
        parseName: function(appset) {
            for (var len = appset.length, newset = [], i = 0; len > i; ++i) {
                var app = appset[i];
                app.name.hasOwnProperty(navigator.language) && (console.log(app.name[navigator.language]), 
                console.log(query), app.name[navigator.language].search(query) && newset.push(app));
            }
            return newset;
        },
