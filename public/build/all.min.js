    ...
    function swapApp(first) {
        ...
        if (first) {
            ...
            onComplete: function() {
                ...
                app = fapps[currentIndex], console.log("currentIndex is now : " + currentIndex);
                var img = new Image();
                img.src = app.icon;
...
}), app.controller("home", [ "$rootScope", "API", "$scope", "$filter", "$http", function($rootScope, API, $scope, $filter) {
