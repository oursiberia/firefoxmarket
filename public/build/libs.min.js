...
function(window, angular, undefined) {
...
}.call(this), angular.module("gettext", []), angular.module("gettext").constant("gettext", function(str) {
    return str;
    ...
    var catalog, prefixDebug = function(string) {
        return catalog.debug && catalog.currentLanguage !== catalog.baseLanguage ? "[MISSING]: " + string : string;
    };
    return catalog = {
        debug: !1,
        strings: {},
        ...
        setCurrentLanguage: function(lang) {
            this.currentLanguage = lang, broadcastUpdated();
        },
        setStrings: function(language, strings) {
            this.strings[language] || (this.strings[language] = {});
            for (var key in strings) {
                var val = strings[key];
                this.strings[language][key] = "string" == typeof val ? [ val ] : val;
            }
            broadcastUpdated();
        },
        getStringForm: function(string, n) {
            var stringTable = this.strings[this.currentLanguage] || {}, plurals = stringTable[string] || [];
            return plurals[n];
        },
        getString: function(string, context) {
            return string = this.getStringForm(string, 0) || prefixDebug(string), context ? $interpolate(string)(context) : string;
        },
        getPlural: function(n, string, stringPlural, context) {
            var form = gettextPlurals(this.currentLanguage, n);
            return string = this.getStringForm(string, form) || prefixDebug(1 === n ? string : stringPlural), 
            context ? $interpolate(string)(context) : string;
        },
        loadRemote: function(url) {
            return $http({
                ...
                for (var lang in data) catalog.setStrings(lang, data[lang]);
            });
        }
    };
    ...
    var trim = function() {
        return String.prototype.trim ? function(value) {
            ...
            return "string" == typeof value ? value.replace(/^\s*/, "").replace(/\s*$/, "") : value;
        };
    }();
    return {
        restrict: "A",
        ...
        compile: function(element, attrs) {
            ...
            var msgid = trim(element.html()), translatePlural = attrs.translatePlural;
            return {
                post: function(scope, element, attrs) {
                    function update() {
                        var translated;
                        translatePlural ? (scope = pluralScope || (pluralScope = scope.$new()), scope.$count = countFn(scope), 
                        translated = gettextCatalog.getPlural(scope.$count, msgid, translatePlural)) : translated = gettextCatalog.getString(msgid);
                        var newWrapper = angular.element("<span>" + translated + "</span>");
                        $compile(newWrapper.contents())(scope);
                        var oldContents = element.contents(), newContents = newWrapper.contents();
                        $animate.enter(newContents, element), $animate.leave(oldContents);
                    }
                    var countFn = $parse(attrs.translateN), pluralScope = null;
                    attrs.translateN && scope.$watch(attrs.translateN, update), scope.$on("gettextLanguageChanged", update), 
                    update();
                }
            };
        }
    ...
    return filter.$stateful = !0, filter;
    ...
    return function(langCode, n) {
        switch (langCode) {
          ...
          case "lt":
            return n % 10 == 1 && n % 100 != 11 ? 0 : n % 10 >= 2 && (10 > n % 100 || n % 100 >= 20) ? 1 : 2;
          ...
          case "ro":
            return 1 == n ? 0 : 0 == n || n % 100 > 0 && 20 > n % 100 ? 1 : 2;
          ...
          case "mt":
            return 1 == n ? 0 : 0 == n || n % 100 > 1 && 11 > n % 100 ? 1 : n % 100 > 10 && 20 > n % 100 ? 2 : 3;

          case "gd":
            return 1 == n || 11 == n ? 0 : 2 == n || 12 == n ? 1 : n > 2 && 20 > n ? 2 : 3;
          ...
          case "ga":
            return 1 == n ? 0 : 2 == n ? 1 : 7 > n ? 2 : 11 > n ? 3 : 4;
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
    ...
    var _doc = document.documentElement, _window = window, _max = function(element, axis) {
        var dim = "x" === axis ? "Width" : "Height", scroll = "scroll" + dim, client = "client" + dim, body = document.body;
        ...
        init: function(target, value, tween) {
            return this._wdw = target === _window, this._target = target, this._tween = tween, 
            "object" != typeof value && (value = {
                y: value
            }), this.vars = value, this._autoKill = value.autoKill !== !1, this.x = this.xPrev = this.getX(), 
            this.y = this.yPrev = this.getY(), null != value.x ? (this._addTween(this, "x", this.x, "max" === value.x ? _max(target, "x") : value.x, "scrollTo_x", !0), 
            this._overwriteProps.push("scrollTo_x")) : this.skipX = !0, null != value.y ? (this._addTween(this, "y", this.y, "max" === value.y ? _max(target, "y") : value.y, "scrollTo_y", !0), 
    ...
    ScrollToPlugin.max = _max, p.getX = function() {
        ...
        return lookup.scrollTo_x && (this.skipX = !0), lookup.scrollTo_y && (this.skipY = !0), 
